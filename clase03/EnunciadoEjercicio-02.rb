...
puts "Ingrese la cantidad de polos"
polos = gets.chomp.to_i
puts "El precio unitario es: " + precio_unitario(polos).to_s
puts "El total a pagar es: "+ total_a_pagar(polos).to_s
